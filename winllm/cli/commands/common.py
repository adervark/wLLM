...
def build_model_config(args) -> ModelConfig:
    ...
    if getattr(args, "suffix_decoding", False):
        kwargs["enable_suffix_decoding"] = True
...
def apply_auto_config(model_config, scheduler_config, kv_cache_config):
    ...
    from ...hardware import DeviceInfo, apply_hardware_defaults
    ...
    apply_hardware_defaults(model_config, scheduler_config, kv_cache_config, hw.defaults)
