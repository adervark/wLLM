...
class TestModelConfig:
    def test_defaults(self):
        ...
        assert c.quantization == QuantizationType.AUTO
    ...
    def test_apply_hardware_defaults_changes_quantization(self):
        from winllm.hardware import HardwareDefaults, apply_model_defaults
        ...
        apply_model_defaults(c, hw)

        # AUTO + hw says "none" → should switch to NONE
    ...
    def test_apply_hardware_defaults_preserves_user_overrides(self):
        ...
        # INT8 != AUTO, so the "change to NONE" logic should NOT trigger
    ...
    def test_apply_with_non_hardware_defaults_is_noop(self):
        from winllm.hardware import apply_model_defaults

        c = ModelConfig(model_name_or_path="test")
        apply_model_defaults(c, "not a HardwareDefaults object")
        assert c.quantization == QuantizationType.AUTO  # Unchanged
...
class TestSchedulerConfig:
    ...
    def test_apply_hardware_defaults(self):
        from winllm.hardware import HardwareDefaults, apply_scheduler_defaults
...
class TestKVCacheConfig:
    ...
    def test_apply_hardware_defaults(self):
        from winllm.hardware import HardwareDefaults, apply_kv_cache_defaults
